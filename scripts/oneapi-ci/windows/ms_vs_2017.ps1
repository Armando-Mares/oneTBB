...
"--add Microsoft.VisualStudio.Component.VC.CppBuildTools",
"--add Microsoft.VisualStudio.Component.TestAdapterForBoostTest",
"--add Microsoft.VisualStudio.Component.TestAdapterForGoogleTest",
...
$activation = Start-Process "${VS_INSTALL_DIR}\Common7\IDE\StorePID.exe" -Wait -NoNewWindow -Verbose -PassThru -ArgumentList "${VS_PRODUCTKEY} ${VS_MPC}"
Start-Sleep -Seconds 5
...
setx VS2017INSTALLDIR "${VS_INSTALL_DIR}"
